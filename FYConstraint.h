...
#ifdef FY_SHORTHAND_GLOBALS

#define equalTo(...)                     fy_equalTo(__VA_ARGS__)
#define greaterThanOrEqualTo(...)        fy_greaterThanOrEqualTo(__VA_ARGS__)
#define lessThanOrEqualTo(...)           fy_lessThanOrEqualTo(__VA_ARGS__)

#define offset(...)                      fy_offset(__VA_ARGS__)
